...
<!-- svgs 시작 -->
<div class="svgs">
  <svg id="avatar-1" width="264px" height="280px" viewBox="0 0 264 280" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <g transform="translate(825.000000, 1100.000000)">
          ...
          <g id="Avataaar" stroke-width="1" fill-rule="evenodd" mask="url(#mask-4)">
            ...
            <g id="Clothing/Collar-+-Sweater" transform="translate(0.000000, 170.000000)">
              ...
              <mask id="react-mask-118" fill="white">
                <use xlink:href="#react-path-117"></use>
              </mask>
              <use id="Clothes" fill="#E6E6E6" fill-rule="evenodd" xlink:href="#react-path-117"></use>
              <g id="Color/Palette/Gray-01" mask="url(#react-mask-118)" fill-rule="evenodd" fill="#262E33">
            ...
            <g id="Top" stroke-width="1" fill-rule="evenodd">
              <defs>
                <rect id="react-path-105" x="0" y="0" width="264" height="280"></rect>
                ...
                <filter x="-0.8%" y="-2.0%" width="101.5%" height="108.0%" filterUnits="objectBoundingBox" id="react-filter-101">
              ...
              <g id="Mask"></g>
              <g id="Top/Short-Hair/Short-Round" mask="url(#react-mask-103)">
                <g transform="translate(-1.000000, 0.000000)">
                  <mask id="react-mask-102" fill="white">
                    <use xlink:href="#react-path-104"></use>
                  </mask>
                  <use id="Short-Hair" stroke="none" fill="#28354B" fill-rule="evenodd" xlink:href="#react-path-104"></use>
                  <g id="Skin/👶🏽-03-Brown" mask="url(#react-mask-102)" fill="#2C1B18">
